...
$(function() {
    ...
    window.addEventListener("message", function(t) {
        ...
        $.post("https://AesxAdmin/" + a, JSON.stringify({
            playerid: id,
            inputData: e
        })), i(!0)
        ...
        let e = $(this).data("itemname"),
            a = parseInt($("#qty").val());
        $.post("https://AesxAdmin/giveitem", JSON.stringify({
            playerid: id,
            name: e,
            amount: a
        }))
        ...
        $.post("https://AesxAdmin/weapon", JSON.stringify({
            playerid: id,
            weapon: e
        }))
    }), $("#vehicles").on("click", ".inventoryitem", function() {
        let e = $(this).data("vehiclename");
        $.post("https://AesxAdmin/spawnvehicle", JSON.stringify({
            model: e
        }))
        ...
        switch (s) {
            ...
            case "promote":
                ...
                $.post("https://AesxAdmin/promote", JSON.stringify({
                    playerid: id,
                    level: o
                }));
                break;
            ...
            case "spawnVehicle":
                ...
                break;
            case "inventory":
                $.post("https://AesxAdmin/inventory", JSON.stringify({
                    playerid: id
                }));
                break;
            case "ban":
            ...
            case "setJob":
                ...
                $.post("https://AesxAdmin/setJob", JSON.stringify({
                    playerid: id,
                    job: r,
                    rank: l
                }));
            ...
            case "changeWeather":
                ...
                $.post("https://AesxAdmin/changeWeather", JSON.stringify({
                    playerid: id,
                    weather: d
                }));
                break;
            default:
                $.post("https://AesxAdmin/" + s, JSON.stringify({
                    playerid: id
                }))
        }
    ...
    $("#inner").append(atob("PGZvb3Rlcj4mY29weTtTb2xhclNjcmlwdHMgQWRtaW4gUGFuZWwgLSBzb2xhcnNjcmlwdHMuc3RvcmU8L2Zvb3Rlcj4=")), document.onkeyup = function(e) {
        if (27 == e.which) return $.post("https://AesxAdmin/exit", JSON.stringify({})), void a(!1)
    }, $("#tpwp-button").click(function() {
        $.post("https://AesxAdmin/tp-wp")
